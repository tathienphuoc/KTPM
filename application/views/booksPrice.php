...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <?php
                    echo "<a class='page-link ' href='" . base_url() . "index.php/Book_Controller/books' >Mặc định</a>";
                    ?>
                    <?php
    ...
    if ($current == 1) {
        ...
        echo "<a class='page-link ' href='" . base_url() . "index.php/Book_Controller/sortByPrice/" . $current . "' >Trước</a>";
        echo "</li>";
        $current += 1;
    }
    for ($i = $begin; $i <= $end; $i++) {
        if ($current == $i) {
            ...
            $current += 1;
            echo "<li class='page-item active'>";
            echo "<a class='page-link ' href='" . base_url() . "index.php/Book_Controller/sortByPrice/" . $i . "' >" . $i . "</a>";
            echo "</li>";
            $current -= 1;
        }
    }
    if ($current == $totalPage) {
        ...
        $current += 1;
        echo "<li class='page-item active'>";
        echo "<a class='page-link ' href='" . base_url() . "index.php/Book_Controller/sortByPrice/" . $current . "' >Sau</a>";
        echo "</li>";
        $current -= 1;
    }
    echo " </ul>";
