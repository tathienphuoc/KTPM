      ...
      <h1>
        ...
        <div class="row">
          <div class="col-md-3">
            ...
            <img src='<?php echo base_url();?>images/book/Book_<?php echo $book->id; ?>.jpg?t=<?php echo time();?>' onerror="this.src='<?php echo base_url();?>images/default/defaultProductImage.jpg'" style="width: 200px;height: 200px;" class="avatar img-circle" alt="Ảnh sản phẩm">
