...
<body>
    ...
    <div class="d-flex">
        <div class="m-auto d-flex">
            ...
            foreach ($books as $book) {
                ...
                echo "</span>";
                echo "</div >";
                echo "<a href='" . base_url() . "index.php/Book_Controller/viewBook/" . $book->id . "' class='btn btn-outline-primary' style='width:100%'>Xem chi tiết</a>";
    ...
    if ($current == 1) {
        ...
        echo "<a class='page-link ' href='" . base_url() . "index.php/Book_Controller/books/" . $current . "' >Trước</a>";
        echo "</li>";
        $current += 1;
    }
    for ($i = $begin; $i <= $end; $i++) {
        if ($current == $i) {
            ...
            $current += 1;
            echo "<li class='page-item active'>";
            echo "<a class='page-link ' href='" . base_url() . "index.php/Book_Controller/books/" . $i . "' >" . $i . "</a>";
            echo "</li>";
            $current -= 1;
        }
    }
    if ($current == $totalPage) {
        ...
        $current += 1;
        echo "<li class='page-item active'>";
        echo "<a class='page-link ' href='" . base_url() . "index.php/Book_Controller/books/" . $current . "' >Sau</a>";
        echo "</li>";
        $current -= 1;
    }
    echo " </ul>";
