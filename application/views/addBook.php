      ...
      <h1>
        ...
        <div class="row">
          <div class="col-md-3">
            ...
            <img src='<?php echo base_url();?>images/default/defaultProductImage.jpg' style="width: 200px;height: 200px;" class="avatar img-circle" alt="Ảnh sản phẩm">
              <h6>Thêm ảnh sản phẩm</h6>
          ...
          <div class="col-md-9 personal-info" >
            ...
            <div class="form-horizontal" >
              <div class="form-group">
                ...
                <div class="col-lg-8">
                  <input class="form-control" name='title' type="text"  placeholder="Hiện chưa có tên" required>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-8">
                  <input class="form-control" type="number" name='publishYear' min="1000" required>
                </div>
              </div>
              <div class="form-group" style="text=align:center">
                <label >Trích dẫn:</label>
                <textarea class="form-control" name='description' style="resize: none;" rows="4" cols="30" placeholder="Hiện chưa mô tả">
                </textarea>
              </div>
            </div>
          </div>
